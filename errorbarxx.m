function [ax,hl1,hl2] = errorbarxx(x1,y1,x2,y2,...
                                    err_1, err_2,...
                                    xlabels,ylabels);
%errorbarxx - Create graphs with x axes on both top and bottom along with 
%               error bars
%
%Similar to PLOTXX, but ...
...
hl2=plot(ax(2),x2,y2,'Parent',ax(2));
